...
EVAL_CONFIG = {"spawn_pos": [0, 0, 0.1], "target_pos": [0, 5, 0.5]}
...
def run_evolution_experiment(
    ...
    evaluate_population(mixed_twisty_population, EVAL_CONFIG["spawn_pos"], EVAL_CONFIG["target_pos"])
...
def main() -> None:
    ...
    visualize_champ(champion_robot, champion, EVAL_CONFIG["spawn_pos"], DATA_SETTINGS, mode="launcher")
