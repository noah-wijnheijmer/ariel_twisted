...
# Local libraries
from simulation.environments.parameters.ariel_types import (
    Dimension,
    Rotation,
)
from simulation.environments._compound_world import CompoundWorld
from simulation.environments.heightmap_functions import (amphitheater_heightmap,rugged_heightmap,)
from simulation.environments.utils.noise_gen import NormMethod
