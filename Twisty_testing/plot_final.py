...
for i in range(30):
    try:
        with open(f"evo_main/experiment_data_non-twisty_champion{i+300}.json", 'r') as file:
            experiment_mixed.append(json.load(file))
    except:
        with open(f"evo_main/experiment_data_twisty_champion{i+300}.json", 'r') as file:
            experiment_mixed.append(json.load(file))
    try:
        with open(f"evo_main/experiment_data_non-twisty_champion{i+330}.json", 'r') as file:
            experiment_twisted.append(json.load(file))
    except:
        with open(f"evo_main/experiment_data_twisty_champion{i+330}.json", 'r') as file:
            experiment_twisted.append(json.load(file))
    try:
        with open(f"evo_main/experiment_data_non-twisty_champion{i+270}.json", 'r') as file:
            experiment_untwisted.append(json.load(file))
    except:
        with open(f"evo_main/experiment_data_twisty_champion{i+270}.json", 'r') as file:
            experiment_untwisted.append(json.load(file))
...
for experiment_data in experiment_mixed:
        ...
        for gen_data in experiment_data["generations"]:
            ...
            if "mixed2" in gen_data:
                stats = gen_data["mixed2"]
...
for experiment_data in experiment_twisted:
        ...
        for gen_data in experiment_data["generations"]:
            ...
            if "twisted2" in gen_data:
                stats = gen_data["twisted2"]
                maxs.append(stats["max"])
...
for experiment_data in experiment_untwisted:
        ...
        for gen_data in experiment_data["generations"]:
            ...
            if "untwisted2" in gen_data:
                stats = gen_data["untwisted2"]
                maxs.append(stats["max"])
...
plt.ylabel('Fitness')
plt.title('Fitness over Generations - Mixed VS Twisted')
plt.legend(loc='lower right')
plt.grid(True, linestyle='--', alpha=0.5)
plt.ylim(0.0935, 0.104)
plt.savefig(f"MT2_fitness.png")
...
plt.xlabel('Generation')
plt.ylabel('Fitness')
plt.title('Fitness over Generations - Untwisted VS Twisted')
plt.legend(loc='lower right')
plt.grid(True, linestyle='--', alpha=0.5)
plt.ylim(0.0935, 0.104)
plt.savefig(f"UT2_fitness.png")
...
plt.xlabel('Generation')
plt.ylabel('Fitness')
plt.title('Fitness over Generations - Untwisted VS Mixed')
plt.legend(loc='lower right')
plt.grid(True, linestyle='--', alpha=0.5)
plt.ylim(0.0935, 0.104) 
plt.savefig(f"UM2_fitness.png")
...
plt.xlabel('Generation')
plt.ylabel('Fitness')
plt.title('Fitness over Generations - Untwisted, Mixed, Twisted')
plt.legend(loc='lower right')
plt.grid(True, linestyle='--', alpha=0.5)
plt.ylim(0.0935, 0.104)
plt.savefig(f"UMT2_fitness.png")