...
from ea_components.evolution.neuro_evolution import NeuroEvolution
# if TYPE_CHECKING:
...
def fitness_function_basic(starting_pos: list[float], history: list[Any]) -> float:
...
def main() -> None:
    ...
    for ind in initial_population:
        ...
        ne = NeuroEvolution(
            ...
            cbb = config.correct_for_bounding_box,
            spawn_z =config.custom_z,
            spawn_xy = config.custom_xy,
